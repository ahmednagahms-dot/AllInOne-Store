...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f3f5fc] flex flex-col items-center justify-center p-4 md:p-8 font-sans relative">
      {/* Top Bar with Language Switcher */}
      <div className="w-full max-w-[1180px] flex justify-end pb-3">
        <LanguageSwitcher />
      </div>
      ...
      <div className="w-full max-w-[1180px] bg-[#dbe5ff] rounded-[32px] grid grid-cols-1 lg:grid-cols-12 overflow-hidden shadow-2xl relative">
        ...
        <div className="lg:col-span-6 p-8 md:p-12 flex flex-col justify-between relative bg-[#dde6fe]">
          <div>
            {/* Logo */}
            <Link to="/" className="inline-flex items-center gap-2.5 text-[#2b64f6] font-bold text-xl mb-8">
          ...
          <div className="relative flex justify-center items-center my-6 py-2">
            <div className="absolute left-0 rtl:left-auto rtl:right-0 top-0 z-20 bg-white/90 backdrop-blur-sm px-3.5 py-1.5 rounded-full shadow-sm border border-white flex items-center gap-1.5">
            ...
            <div className="absolute right-0 rtl:right-auto rtl:left-0 top-1/2 -translate-y-1/2 z-20 bg-white/90 backdrop-blur-sm px-3.5 py-1.5 rounded-full shadow-sm border border-white">
              <span className="text-[11px] font-bold tracking-wider text-[#0038DC]">
                {t("auth.badgeWay")}
              </span>
            </div>
        ...
        {/* ================= Right Side ================= */}
        <div className="lg:col-span-6 py-12 px-8 md:px-12 flex flex-col justify-center bg-white rounded-t-[32px] lg:rounded-t-none lg:rounded-l-[32px] rtl:lg:rounded-l-none rtl:lg:rounded-r-[32px] shadow-2xl relative z-30">
          <div className="max-w-[460px] w-full mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-[#10245A] mb-3 tracking-tight">
              {t("auth.loginTitle")}
            </h2>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-5 py-3.5 rounded-2xl bg-[#eff4ff] border border-[#dbe5ff] text-base text-[#0f172a] placeholder-[#94a3b8] focus:outline-none focus:ring-2 focus:ring-[#2b64f6]/30 focus:border-[#2b64f6] transition-all pr-12 rtl:pr-5 rtl:pl-12 font-medium"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 rtl:right-auto rtl:left-4 top-1/2 -translate-y-1/2 text-[#94a3b8] hover:text-[#475569] transition-colors p-1 cursor-pointer"
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-2.5 py-3.5 px-4 border-2 border-[#e2e8f0] rounded-2xl hover:bg-slate-50 hover:border-slate-300 transition-all text-sm font-bold text-[#334155] active:scale-[0.98] cursor-pointer"
              >
